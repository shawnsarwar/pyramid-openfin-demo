...
@REM reg add "HKCU\Software\OpenFin\RVM\Settings" -v "DesktopOwnerSettings" -d "https://shawnsarwar.github.io/pyramid-openfin-demo/settings/dos.json"
reg add "HKCU\Software\OpenFin\RVM\Settings" -v "DesktopOwnerSettings" -d "https://shawnsarwar.github.io/pyramid-openfin-demo/settings/dos.json"
